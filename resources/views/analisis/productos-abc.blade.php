...
@section('main-content')
    ...
    <h3 class="mb-3">{{ __('ABC Classification') }}</h3>

    <h4 class="text-center">Año: {{$anio}}</h4>
    
    <h5 class="text-center mt-4">Productos Tipo A</h5>
    ...
    <h5 class="text-center mt-4">Productos Tipo B</h5>
    ...
    <h5 class="text-center mt-4">Productos Tipo C</h5>
